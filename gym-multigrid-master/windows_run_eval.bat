...
call python eval_env.py --env simple --model_type COMA
call python eval_env.py --env simple --model_type COMA --use_kg --kg_set 0 --load_model_path <weights_directory>
call python eval_env.py --env simple --model_type COMA --use_kg --kg_set 1 --load_model_path <weights_directory>
call python eval_env.py --env simple --model_type COMA --use_kg --kg_set 2 --load_model_path <weights_directory>
call python eval_env.py --env simple --model_type COMA --use_kg --kg_set 3 --load_model_path <weights_directory>
...
call python eval_env.py --env lava --model_type COMA --load_model_path <weights_directory>
call python eval_env.py --env lava --model_type COMA --use_kg --load_model_path <weights_directory>
...
call python eval_env.py --env key --model_type COMA --load_model_path <weights_directory>
call python eval_env.py --env key --model_type COMA --use_kg --load_model_path <weights_directory>
